/*
    ...
    This file is part of st7305-tft-lcd-demo.

    st7305-tft-lcd-demo is free software: you can redistribute it
    and/or modify it under the terms of the GNU Lesser General Public
    License as published by the Free Software Foundation, either
    version 3 of the License, or (at your option) any later version.

    st7305-tft-lcd-demo is distributed in the hope that it will be
    useful, but WITHOUT ANY WARRANTY; without even the implied
    warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.
    See the GNU Lesser General Public License for more details.

    You should have received a copy of the GNU Lesser General Public
    License along with st7305-tft-lcd-demo. If not,
...
void FTEssentials_GetStrBounds(FTEssentials_State *state, const char *str, FT_F26Dot6 *out_top, FT_F26Dot6 *out_left, FT_F26Dot6 *out_right, FT_F26Dot6 *out_bottom, bool fixed_advance)
{
    ...
    while (*str != 0)
    {
        ...
        this_glyph_y2 = this_glyph_y1 + size_y;
        if (!fixed_advance)
        {
